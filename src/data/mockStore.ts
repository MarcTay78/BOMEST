...
let materials: Material[] = [
  ...
  { id: 'm8', name: 'Corrugated Box — Large', category: 'Packaging', item: 'Box', type: '', size: 'Large', unit: 'pcs', currentPrice: 4.2, isComposite: false, isEstimate: false, updatedAt: '2026-06-02' },
];
